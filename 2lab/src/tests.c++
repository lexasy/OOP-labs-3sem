...
TEST(test_02, basic_test_set) // Fill-array and copy constructor test
{
    ...
    ASSERT_TRUE(num1.equals(num2) == true);
}
...
TEST(test_05, basic_test_set) 
{
    ...
    Twelwe result(num1.add(num2));
    ASSERT_TRUE(answer.equals(result) == true);
}
...
{
    Twelwe num1("0123AB"); Twelwe num2; Twelwe answer("123AB");
    Twelwe result(num1.substraction(num2));
    ASSERT_TRUE(answer.equals(result) == true);
}
...
TEST(test_11, basic_test_set)
{
    ...
    EXPECT_THROW(Twelwe result(num1.substraction(num2)), std::string);
}
...
TEST(test_20, basic_test_set)
{
    ...
    ASSERT_TRUE(num1.equals(num2) == false);
}
